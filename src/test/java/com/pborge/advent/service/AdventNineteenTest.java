...
@SpringBootTest
public class AdventNineteenTest {
    @Mock
    private WebRepository webRepository;

    private AdventServiceNineteen testService;

    private final String TEST_INPUT = "";

    @BeforeEach
    void setup() {
        testService = new AdventServiceNineteen(webRepository);
    }

    @Test
    void adventOne_testInput_testOutput() {
        when(webRepository.getData(19)).thenReturn(TEST_INPUT);
