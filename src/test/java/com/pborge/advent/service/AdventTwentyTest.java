...
@SpringBootTest
public class AdventTwentyTest {
    @Mock
    private WebRepository webRepository;

    private AdventServiceTwenty testService;

    private final String TEST_INPUT = "";

    @BeforeEach
    void setup() {
        testService = new AdventServiceTwenty(webRepository);
    }

    @Test
    void adventOne_testInput_testOutput() {
        when(webRepository.getData(20)).thenReturn(TEST_INPUT);
